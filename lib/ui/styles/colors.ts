...
const Colors = {
  light: {
    ...
    cafe: {
      ...
      tertiaryContainer: "rgb(255, 223, 159)",
  ...
  dark: {
    ...
    cafe: {
      primary: "rgb(223, 168, 57)",
      onPrimary: "rgb(14, 13, 12)",
      primaryContainer: "rgb(14, 13, 12)",
      onPrimaryContainer: "rgb(255, 222, 168)",
      secondary: "rgb(255, 209, 116)",
      onSecondary: "rgb(14, 13, 12)",
      secondaryContainer: "rgb(215, 175, 97)",
      onSecondaryContainer: "rgb(14, 13, 12)",
      tertiary: "rgb(255, 219, 148)",
      onTertiary: "rgb(14, 13, 12)",
      tertiaryContainer: "rgb(14, 13, 12)",
      onTertiaryContainer: "rgb(255, 223, 159)",
      error: "rgb(255, 180, 171)",
      onError: "rgb(105, 0, 5)",
      errorContainer: "rgb(147, 0, 10)",
      onErrorContainer: "rgb(255, 180, 171)",
      ...
      surface: "rgb(14, 13, 12)",
      onSurface: "rgb(234, 225, 217)",
      surfaceVariant: "rgb(14, 13, 12)",
      onSurfaceVariant: "rgb(209, 197, 180)",
      outline: "rgb(154, 143, 128)",
      outlineVariant: "rgb(14, 13, 12)",
      shadow: "rgb(0, 0, 0)",
      scrim: "rgb(0, 0, 0)",
      inverseSurface: "rgb(234, 225, 217)",
      inverseOnSurface: "rgb(14, 13, 12)",
      inversePrimary: "rgb(14, 13, 12)",
      elevation: {
        level0: "transparent",
        level1: "rgb(30, 29, 28)",
        level2: "rgb(14, 13, 12)",
